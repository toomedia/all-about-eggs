...
// export default CustomizeEggCard
...
const CustomizeEggCard = () => {
  ...
  const designOption = {
    id: "customize",
    title: t["customizeEgg"].title,
    description: t["customizeEgg"].description,
    icon: <Palette className="w-6 h-6" />,
    color: "from-purple-500 to-pink-500",
  };
  ...
  return (
    <div>
      ...
      >
        <div className="bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl p-6 sm:p-8 border-2 border-gray-200/50 hover:border-[#f6e79e] transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-105">
          <div
            className={`w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r ${designOption.color} rounded-xl sm:rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6 text-white group-hover:scale-110 transition-transform duration-300`}
          >
            {designOption.icon}
          </div>
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 sm:mb-3 text-center font-manrope">
