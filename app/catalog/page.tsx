            ...
            {surpriseStep === 1 && (
              <div className="p-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-2 font-manrope">Choose your surprise!</h2>
                  <p className="text-gray-600">What kind of egg adventure are you looking for?</p>
                </div>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <button
                      ...
                      className={`w-full p-4 rounded-2xl border-2 border-gray-200 hover:border-transparent transition-all transform hover:scale-105 shadow-lg hover:shadow-xl bg-gradient-to-r ${option.color} text-white text-left`}
                    >
            ...
            {surpriseStep === 2 && (
              <div className="p-8 text-center">
                <div className="mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-4 font-manrope">Creating your surprise...</h2>
            ...
            {surpriseStep === 3 && (
              <div className="p-8">
                <div className="text-center mb-8">
                  ...
                  <h2 className="text-2xl font-bold text-gray-900 mb-2 font-manrope">Ta-da! Your surprise is ready!</h2>
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-4 gap-2 max-h-48 overflow-y-auto rounded-xl p-2 bg-gray-50">
                    {surpriseResult.map((design, index) => (
                      <div key={index} className="relative aspect-square rounded-lg overflow-hidden border-2 border-purple-200">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity">
                          <div className="absolute bottom-1 left-1 text-white text-xs font-medium truncate w-full px-1">
                            {design.name}
                          </div>
                        </div>
                      </div>
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-pink-500 hover:to-purple-500 text-white py-4 rounded-2xl font-semibold transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                    View My Surprise
                  </button>
                  <button
