...
export default function ConfiguratorPage() {
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 mb-6 sm:mb-8">
        <div className="flex items-start sm:items-center gap-4 sm:gap-6 w-full sm:w-auto">
          <button
            ...
            className="p-2 sm:p-3 hover:bg-gray-100/80 rounded-2xl transition-all duration-300 hover:scale-105"
          >
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-sm sm:text-base">
              {t.configurator?.subtitle || "Create your perfect memory game set"}
            </p>
          </div>
        </div>
  ...
  <div className="flex items-center gap-2 sm:gap-3">
    <button
      ...
      className="relative p-2 sm:p-3 hover:bg-gray-100/80 rounded-2xl transition-all duration-300 hover:scale-105 group"
    >
      <ShoppingCart className="w-6 h-6 sm:w-7 sm:h-7 text-gray-700 group-hover:text-gray-900 transition-colors" />
      {cartItems.length > 0 && (
        <span className="absolute -top-2 -right-2 w-5 h-5 sm:w-6 sm:h-6 bg-gradient-to-r from-[#f6e79e] to-[#f4e285] text-gray-900 rounded-full flex items-center justify-center text-[10px] sm:text-xs font-bold shadow-lg animate-pulse">
    ...
    {cartItems.length > 0 && (
      <span className="text-xs sm:text-sm text-gray-600 font-medium">
        {cartItems.reduce((sum, item) => sum + (item.designs ? item.designs.length : 0), 0)}{" "}
        {cartItems.reduce((sum, item) => sum + (item.designs ? item.designs.length : 0), 0) !== 1
          ? t.configurator?.itemsInCart || "items in cart"
          : t.configurator?.itemInCart || "item in cart"}
      </span>
    )}
  </div>
              
           <div className="text-right mt-4 sm:mt-0">
  <p className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-[#f6e79e] to-[#f4e285] bg-clip-text text-transparent">
    €{calculateTotalPrice()}
  </p>
  <p className="text-xs sm:text-sm text-gray-500 font-medium">
    {t.configurator?.totalPrice || "Total Price"}
  </p>
</div>
</div>
</div>
...
<div className="flex items-center justify-center px-4 sm:px-6">
  <div className="flex flex-wrap sm:flex-nowrap items-center justify-center gap-6 sm:gap-8">
    {steps.map((step, index) => (
      <div key={step.id} className="flex items-center">
        ...
        >
          <div
            className={`w-14 h-14 sm:w-16 sm:h-16 rounded-2xl flex items-center justify-center mb-2 sm:mb-3 transition-all duration-500 shadow-lg ${
              step.completed
                ? 'bg-gradient-to-br from-[#f6e79e] to-[#f4e285] text-gray-900 shadow-xl scale-105 sm:scale-110'
        ...
        {index < steps.length - 1 && (
          <div
            className={`hidden sm:block w-16 sm:w-20 h-1 mx-4 sm:mx-6 rounded-full transition-all duration-500 ${
              step.completed
  ...
  <div className={`transition-all duration-700 ${currentStep >= 1 ? 'opacity-100 translate-y-0' : 'opacity-50 translate-y-4'}`}>
    <div className="text-center mb-10 sm:mb-12">
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4 sm:mb-6">
        {t.configurator?.chooseSetSize || "Choose Your Set Size"}
      </h2>
      <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-xl md:max-w-3xl mx-auto leading-relaxed">
  ...
  {setSizes.map((size) => (
    ...
    >
      ...
      <div className={`transition-all duration-700 px-4 sm:px-6 lg:px-8 ${currentStep >= 2 ? 'opacity-100 translate-y-0' : 'opacity-50 translate-y-4'}`}>
  <div className="text-center mb-12">
    <h2 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-6">
    ...
    <p className="text-gray-600 text-base sm:text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
      {t.configurator?.chooseDesignsDesc || "Select from our curated collections, let us surprise you, or create your own designs with AI."}
        ...
        {/* Creation Options */}
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-6 lg:px-8 mb-12">
  {/* Preset Collections */}
  <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500">
    <div className="text-center mb-6 sm:mb-8">
      <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
      ...
      <p className="text-gray-600 text-sm sm:text-base">Choose from curated themes</p>
    </div>
  ...
  {presetCollections.map((collection) => (
    <div
      ...
      className={`p-4 sm:p-5 rounded-2xl border-2 cursor-pointer transition-all duration-300 hover:scale-105 ${
    ...
    >
      <div className="flex items-center gap-4 sm:gap-5">
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-2xl overflow-hidden shadow-lg">
          <Image
        ...
        <div className="flex-1">
          <h4 className="font-semibold text-gray-900 text-base sm:text-lg">{collection.name}</h4>
...
<div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500">
  <div className="text-center mb-6 sm:mb-8">
    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-pink-500 to-red-600 rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
      <Gift className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
    </div>
    <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-2 sm:mb-3">
      Surprise Me
    </h3>
    <p className="text-gray-600 text-sm sm:text-base">Let AI create a perfect set</p>
  </div>

  <button
    onClick={generateSurpriseSet}
    className="w-full py-3 sm:py-4 bg-gradient-to-r from-pink-500 to-red-600 text-white rounded-2xl font-bold text-base sm:text-lg hover:from-pink-600 hover:to-red-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
  >
    <Gift className="w-4 h-4 sm:w-5 sm:h-5 inline mr-2" />
    Generate Surprise Set
  </button>
</div>
...
<div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-white/20 shadow-xl hover:shadow-2xl transition-all duration-500">
  <div className="text-center mb-6 sm:mb-8">
    <div className="w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br from-purple-500 to-pink-600 rounded-3xl flex items-center justify-center mx-auto mb-4 sm:mb-6 shadow-lg">
      <Wand2 className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
    </div>
    <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-2 sm:mb-3">
      AI Design Studio
    </h3>
    <p className="text-gray-600 text-sm sm:text-base">Create custom designs with AI</p>
  </div>

  <button
    onClick={() => setShowAISection(true)}
    className="w-full py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-600 text-white rounded-2xl font-bold text-base sm:text-lg hover:from-purple-600 hover:to-pink-700 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
  >
    <Wand2 className="w-4 h-4 sm:w-5 sm:h-5 inline mr-2" />
    Open AI Studio
  </button>
</div>
</div>
         ...
         {showAISection && (
  <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 sm:p-8 mb-10 sm:mb-12 border border-white/20 shadow-xl">
    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 mb-6 sm:mb-8">
      <div>
        <h3 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-1 sm:mb-2">
          AI Design Studio
        </h3>
        <p className="text-gray-600 text-sm sm:text-base">
          Create custom designs with the power of AI
        </p>
      </div>
      ...
      <div className="space-y-6">
        <div>
          ...
          <textarea
            ...
            className="w-full h-28 sm:h-32 px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#f6e79e] resize-none shadow-sm"
          />
          {!aiPrompt.trim() && (
  ...
  className="w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-pink-500 hover:to-purple-500 text-white rounded-2xl font-bold transition-all transform hover:scale-105 flex items-center justify-center gap-2 shadow-lg text-sm sm:text-base"
>
    ...
    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
      {templates.map((template) => (
        <div
          ...
          className={`relative aspect-square rounded-2xl overflow-hidden border-2 cursor-pointer transition-all duration-300 transform ${
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
            <div className="absolute bottom-2 left-2 right-2">
              <p className="text-white text-xs sm:text-sm font-bold">{template.name}</p>
